export enum SocietalInputEnum {
  CUSTOMER_SATISFACTION = "Customer Satisfaction",
  CUSTOMER_AFFORDABILITY = "Customer Affordability",
  ...
  KNOWLEDGE_SHARING_ACROSS_THE_SUPPLY_CHAIN = "Knowledge Sharing Across the Supply Chain",
